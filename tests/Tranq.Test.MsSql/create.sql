IF  EXISTS (SELECT name FROM sys.databases WHERE name = N'TranqTest')
    DROP DATABASE [TranqTest];
GO

create database [TranqTest];
GO

ALTER DATABASE [TranqTest] SET READ_COMMITTED_SNAPSHOT ON;
GO
